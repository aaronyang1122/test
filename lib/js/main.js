            	...
            	switch(category)
	              {
	              	case "2":
	              	// 储值卡
	              		redirect_url += "&userId=" + userId + "&userSign=" + userSign + "&cityId=" + cityId + "&redirect=card";
	              		break;
	              	case "1":
	              	// 包月卡
	              		redirect_url += "&userId=" + userId + "&userSign=" + userSign + "&cityId=" + cityId;
	              		break;
	              }
            	...
            	var _param = {
			              	...
			              	if(list.length == 1){
			              		switch(list[0].category)
					              {
					              	case 2:
					              	// 储值卡
					              		redirect_url += "&userId=" + list[0].userId  + "&userSign=" + list[0].privateKey + "&cityId=" + _localParam.cityId + "&redirect=card";
					              		break;
					              	case 1:
					              	// 包月卡
					              		redirect_url += "&userId=" + list[0].userId  + "&userSign=" + list[0].privateKey + "&cityId=" + _localParam.cityId;
					              		break;
					              }
