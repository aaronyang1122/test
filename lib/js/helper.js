Handlebars.registerHelper({
	...
	"miaoshajia": function(res, options){
		typeof(res.childDiscountPrice) == "string"? parseInt(res.childDiscountPrice):parseInt(res.childDiscountPrice);
		typeof(res.childNum) == "string"? parseInt(res.childNum):res.childNum;
		typeof(res.discountPrice) == "string"? parseInt(res.discountPrice):parseInt(res.discountPrice);
		typeof(res.adultNum) == "string"? parseInt(res.adultNum):res.adultNum;
		return (res.childDiscountPrice*res.childNum + res.discountPrice*res.adultNum)+".00";
	},
	"yuanjia": function(res, options){
		typeof(res.childStorePrice) == "string"? parseInt(res.childStorePrice):parseInt(res.childStorePrice);
		typeof(res.childNum) == "string"? parseInt(res.childNum):res.childNum;
		typeof(res.storePrice) == "string"? parseInt(res.storePrice):parseInt(res.storePrice);
		typeof(res.adultNum) == "string"? parseInt(res.adultNum):res.adultNum;
		return (res.childStorePrice*res.childNum + res.storePrice*res.adultNum)+".00";
	},
});